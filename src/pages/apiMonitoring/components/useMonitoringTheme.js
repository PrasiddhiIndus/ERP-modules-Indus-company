...
export function useMonitoringThemeClasses(theme) {
  ...
  return useMemo(
    () => ({
      ...
      accent: dark ? "text-blue-400" : "text-accent",
      accentBg: dark ? "bg-blue-600 hover:bg-blue-500" : "bg-accent hover:bg-accent-deep",
      accentSoft: dark ? "bg-blue-950/50 text-blue-300 border-blue-800" : "bg-blue-50 text-accent border-blue-200",
      ...
      chartGrid: dark ? "var(--text-strong)" : "var(--chart-grid)",
      chartTick: dark ? "var(--text-disabled)" : "var(--text-muted)",
      tooltipBg: dark ? "var(--text)" : "var(--surface)",
      tooltipBorder: dark ? "var(--text-secondary)" : "var(--border)",
