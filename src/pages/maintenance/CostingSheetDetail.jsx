...
const CostingSheetDetail = () => {
  ...
  const handleSaveAndNext = () => {
    ...
    navigate(`/app/maintenance/quotation-tracker/internal-quotation/${id}`);
  };
          ...
          <div className="flex justify-between items-center mb-4">
            <div>
              ...
              <p className="text-sm text-gray-600 mt-1">
                Quotation: {quotation.quotation_number} | Client: {quotation.maintenance_clients?.client_name || '-'}
              </p>
            </div>
            <div className="flex gap-3">
              <button
                onClick={() => navigate('/app/maintenance/quotation-tracker')}
