  ...
  const handleExport = () => {
    const exportData = enquiries.map(enquiry => {
      ...
      return {
        ...
        'Client': enquiry.maintenance_clients?.client_name || '-',
                ...
                <tbody className="bg-white divide-y divide-gray-100">
                  {(() => {
                    ...
                    const filteredEnquiries = enquiries.filter(enquiry => {
                      ...
                      const clientName = enquiry.maintenance_clients?.client_name?.toLowerCase() || '';
                    ...
                    <tr key={enquiry.id} className="hover:bg-purple-50/30 transition-colors" data-is-last-row={isLastRow}>
                      ...
                      <td className="px-3 py-2">
                        <span className="text-xs text-gray-700 font-medium">
                          {enquiry.maintenance_clients?.client_name || '-'}
                        </span>
                      </td>
                      <td className="px-3 py-2">
              ...
              <div className="bg-gray-50 rounded-lg p-4 sm:p-5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <div className="bg-white border border-gray-200 rounded-lg px-3 py-2.5">
                      <p className="text-sm text-gray-900">
                        {viewingEnquiry.maintenance_clients?.client_name || <span className="text-gray-400 italic">Not provided</span>}
                      </p>
                    </div>
                  </div>
                  <div>
              ...
              <div className="bg-gray-50 rounded-lg p-4 sm:p-5">
                ...
                {documentsLoadError && (
                  <div className="mb-3 p-3 bg-amber-50 border border-amber-200 rounded-lg text-sm text-amber-800">
                    {documentsLoadError} Ensure table &quot;{ENQUIRY_DOCUMENTS_TABLE}&quot; exists — run <code className="text-xs bg-amber-100 px-1 rounded">maintenance_enquiry_documents_schema.sql</code> in Supabase SQL Editor.
                  </div>
                )}
