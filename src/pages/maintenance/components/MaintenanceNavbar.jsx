...
const MaintenanceNavbar = () => {
  ...
  const navItems = [
    { path: '/app/maintenance', icon: LayoutDashboard, label: 'Dashboard' },
    { path: '/app/maintenance/enquiry-master', icon: FileText, label: 'Enquiry Master' },
    { path: '/app/maintenance/quotation-tracker', icon: DollarSign, label: 'Quotation Tracker' },
    { path: '/app/maintenance/follow-up-planner', icon: Calendar, label: 'Follow-up Planner' },
