/**
 * Maintenance internal quotation PDF — Indus letterhead style
...
export function resolveQuotationTermsSources(formData = {}, quotation = {}) {
  ...
  // maintenance_quotations.payment_terms is often used as costing description —
 ...
 * @returns {jsPDF}
 */
export function buildMaintenanceInternalQuotationPdf(opts) {
  const {
    quotation,
    client,
    formData,
