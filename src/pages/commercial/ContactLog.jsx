    ...
    <div className="w-full overflow-y-auto p-4 sm:p-6 space-y-6">
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
        ...
        {filteredList.length === 0 && (
          <div className="p-8 text-center text-gray-500">No PO found. Add POs in PO Entry first.</div>
        )}
      </div>
      ...
      {viewHistoryPoId && poForHistory && (
        <div className="fixed inset-0 z-50 overflow-y-auto bg-black/50 flex items-center justify-center p-4">
          <div className="bg-white rounded-xl shadow-xl max-w-2xl w-full p-6">
            ...
            <p className="text-sm text-gray-500 mb-4">Names/numbers of previous coordinators (coordinator may change during contract)</p>
            <div className="overflow-x-auto">
