import { PAYROLL_ENTRY_COLUMNS } from "../../adminOperations/payroll/attendanceSheetExcel";

export const PAYROLL_PACKAGES_STORAGE_KEY = "indus-hr-payroll-formula-packages";
export const PAYROLL_ENTRY_SELECTED_PACKAGE_KEY = "indus-hr-payroll-entry-selected-package-id";
