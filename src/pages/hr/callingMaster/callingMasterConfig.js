...
export const CALLING_MASTER_TABLE_COLUMNS = [
  ...
  { key: "heightCm", label: "Height", widthClassName: "w-[80px] min-w-[80px] max-w-[80px]" },
  { key: "weightKg", label: "Weight", widthClassName: "w-[80px] min-w-[80px] max-w-[80px]" },
  { key: "homeState", label: "Home State", widthClassName: "w-[120px] min-w-[120px] max-w-[120px]" },
  { key: "homeTown", label: "Home Town", widthClassName: "w-[130px] min-w-[130px] max-w-[130px]" },
  { key: "currentlyWorking", label: "Currently Working", widthClassName: "w-[128px] min-w-[128px] max-w-[128px]" },
  { key: "designation", label: "Designation", widthClassName: "w-[140px] min-w-[140px] max-w-[140px]" },
  { key: "company", label: "Company", widthClassName: "w-[156px] min-w-[156px] max-w-[156px]" },
  { key: "workingState", label: "Working State", widthClassName: "w-[120px] min-w-[120px] max-w-[120px]" },
  { key: "contractor", label: "Contractor", widthClassName: "w-[130px] min-w-[130px] max-w-[130px]" },
  { key: "industryWorked", label: "Industry Worked", widthClassName: "w-[140px] min-w-[140px] max-w-[140px]" },
  { key: "salaryGross", label: "Salary Gross", widthClassName: "w-[110px] min-w-[110px] max-w-[110px]" },
  { key: "facilitiesProvided", label: "Facilities Provided", widthClassName: "w-[160px] min-w-[160px] max-w-[160px]" },
  { key: "totalExperience", label: "Total Experience", widthClassName: "w-[120px] min-w-[120px] max-w-[120px]" },
  { key: "hmvLmv", label: "HMV / LMV", widthClassName: "w-[96px] min-w-[96px] max-w-[96px]" },
  { key: "drivingLicenseYear", label: "Year of Issue", widthClassName: "w-[104px] min-w-[104px] max-w-[104px]" },
  { key: "remarks", label: "Remarks", widthClassName: "w-[200px] min-w-[200px] max-w-[200px]" },
  { key: "siteSuitable", label: "Site Suitable", widthClassName: "w-[128px] min-w-[128px] max-w-[128px]" },
  { key: "attachments", label: "Files", widthClassName: "w-[112px] min-w-[112px] max-w-[112px]" },
];
