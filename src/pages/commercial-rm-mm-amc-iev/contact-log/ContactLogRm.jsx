...
const ContactLog = ({ commercialPOs = [] }) => {
              ...
              <table className="w-full min-w-0 max-w-full table-fixed border-collapse">
                <thead>
                  <tr>
                    ...
                    <th className="px-1.5 sm:px-2 py-2 sm:py-2.5 text-center text-[10px] sm:text-xs font-bold text-black border-b border-gray-200 bg-info-soft min-w-0 w-[16%]">
                      Contact Number
                    </th>
                    <th className="px-1.5 sm:px-2 py-2 sm:py-2.5 text-center text-[10px] sm:text-xs font-bold text-black border-b border-gray-200 bg-info-soft min-w-0 w-[16%]">
                      Email ID
                    </th>
                    <th className="px-1.5 sm:px-2 py-2 sm:py-2.5 text-center text-[10px] sm:text-xs font-bold text-black border-b border-gray-200 bg-info-soft min-w-0 w-[12%]">
                      Actions
                    </th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-gray-200 bg-white">
                  {paginatedList.map((po, idx) => (
                    <tr key={po.id} className="hover:bg-gray-50 align-top">
                      ...
                      <td className="px-1.5 sm:px-2 py-2 text-[10px] sm:text-xs text-gray-700 min-w-0 text-center">
                        <TextCell value={po.contactEmail} className="text-center" />
                      </td>
                    ...
                    <tbody className="divide-y divide-gray-200 bg-white">
                      {(poForHistory.contactHistoryLog || []).map((h, i) => (
                        <tr key={i} className="hover:bg-gray-50">
                          ...
                          <td className="px-2 py-2 text-xs text-gray-700 text-center min-w-0 truncate" title={h.email}>
                            {h.email || '–'}
                          </td>
