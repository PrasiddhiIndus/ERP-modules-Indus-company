...
export const NAV_MODULE_TREE = [
  {
    ...
    subModules: [
      ...
      { value: "hr.site-attendance",     label: "Site Attendance",    pathPrefix: "/app/hr/site-attendance" },
    ],
  },
  {
    value: "compliance",
  ...
  },
  {
    ...
    subModules: [
      ...
      { value: "marketing.lead-dashboard",  label: "Lead Dashboard",            pathPrefix: "/app/marketing/lead-dashboard" },
      { value: "marketing.lead-master",     label: "Lead Master",               pathPrefix: "/app/marketing/lead-master" },
      ...
      { value: "marketing.product-catalog", label: "Product Catalogs",          pathPrefix: "/app/marketing/product-catalog" },
      ...
      { value: "marketing.mail-template",   label: "Marketing Mail Template",   pathPrefix: "/app/marketing/mail-templates" },
...
export const MODULE_PATH_PREFIXES = {
  ...
  hr: ["/app/hr", "/app/hr/payroll/salary", "/app/hr/payroll-ops", "/app/attendance", "/app/salary", "/app/people-management", "/app/hr/site-iom", "/app/hr/site-attendance"],
