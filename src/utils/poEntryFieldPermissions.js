...
export const PO_ENTRY_FIELD = {
  ...
  ACTUAL_MOBILIZATION_DATE: 'actualMobilizationDate',
  END_DATE: 'endDate',
  ...
  ACCOMMODATION_SCOPE: 'accommodationScope',
  TRANSPORTATION_SCOPE: 'transportationScope',
  PO_COPY: 'poCopy',
...
const TIMELINES_EXPANDED = [
  F.START_DATE,
  F.ACTUAL_MOBILIZATION_DATE,
  F.END_DATE,
  F.BILLING_TYPE,
  F.MANPOWER_DETAILS,
  F.RELIEVER_SCOPE,
  F.ACCOMMODATION_SCOPE,
  F.TRANSPORTATION_SCOPE,
  F.PAYMENT_TERMS,
  F.REMARKS,
  F.WITH_FIRE_TENDER,
...
const FIELD_TO_CLIENT_KEYS = {
  ...
  [F.PLACE_OF_SUPPLY]: ['placeOfSupply', 'isSez', 'gstSupplyType'],
  [F.CONTACT_POC]: [
    'contactPersons',
    'currentCoordinator',
    'contactDesignation',
  ...
  [F.PO_FINANCIALS]: [
    ...
    'invoiceTermsText',
    'poEffectiveDate',
    'priceEscalationEnabled',
    'rateEscalationCount',
  ],
  [F.TAX_SERVICE]: ['serviceDescription', 'sacCode', 'hsnCode'],
  [F.TAX_INVOICE_PRINT]: ['invoiceTermsText'],
  [F.START_DATE]: ['startDate'],
  [F.ACTUAL_MOBILIZATION_DATE]: ['actualMobilizationDate'],
  [F.END_DATE]: ['endDate'],
  [F.BILLING_TYPE]: [
    'billingType',
    'monthlyDutyQtyMode',
  ...
  [F.ACCOMMODATION_SCOPE]: ['accommodationScope'],
  [F.TRANSPORTATION_SCOPE]: ['transportationScope'],
...
const FIELD_TO_DB_COLUMNS = {
  ...
  [F.PLACE_OF_SUPPLY]: ['place_of_supply', 'gst_supply_type'],
  ...
  [F.PO_FINANCIALS]: [
    ...
    'rate_escalation_count',
  ],
  [F.TAX_SERVICE]: ['service_description', 'sac_code', 'hsn_code'],
  ...
  [F.ACCOMMODATION_SCOPE]: ['accommodation_scope'],
  [F.TRANSPORTATION_SCOPE]: ['transportation_scope'],
...
const CREATE_CLIENT_DEFAULTS = {
  ...
  manpowerDetails: [{ designation: '', noOfManpower: '', dutyPattern: '', customDutyPattern: '' }],
  renewalCycles: [],
