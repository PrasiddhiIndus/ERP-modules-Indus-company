  ...
  return (
    <div className="space-y-4">
      <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
        <KpiTile label="Active roster (sample)" value={String(activeCount)} sub="Pulls from Employee Master when wired" onClick={() => navigate(employeeMasterPath)} />
      ...
      <SectionCard
        title="Workflow"
        right={<Badge tone="bg-blue-50 text-blue-800">{workflowBadge}</Badge>}
      >
        ...
        <p className="text-[11px] text-gray-500 mt-2">
          ...
          {entryPhase === "sheet" ? (
            <>
              ...
              {salaryColumns.length} columns). Configure packages under <strong>{formulaNavHint}</strong>.
            </>
          ) : null}
        </p>
      </SectionCard>
